...
class TagModelUsageTest extends TestCase
{
    protected $lesson;
    ...
    {
        $this->lesson->tag(Tag::where('slug', 'laravel')->first());
    ...
    {
        $tags = Tag::whereIn('slug', ['laravel', 'php', 'redis'])->get();
    ...
    {
        $tags = Tag::whereIn('slug', ['laravel', 'testing'])->get();

        $toRetag = Tag::whereIn('slug', ['laravel', 'postgres', 'redis'])->get();
    ...
    {
        $tagsCollection = Tag::whereIn('slug', ['laravel', 'testing'])->get();

        $tagsCollection->push('not a tag model');
